...
namespace Microsoft.Azure.Commands.Scheduler.Cmdlets
{
    ...
    /// </summary>
<<<<<<< HEAD
    [Cmdlet(VerbsLifecycle.Disable, "AzureRmSchedulerJobCollection", SupportsShouldProcess = true), OutputType(typeof(string))]
=======
    [Cmdlet("Disable", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "SchedulerJobCollection", SupportsShouldProcess = true), OutputType(typeof(string))]
>>>>>>> upstream/preview
    public class DisableAzureSchedulerJobCollectionCommand : SchedulerBaseCmdlet
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            this.ConfirmAction(
                processMessage: string.Format(Resources.DisableJobCollectionResourceDescription, this.JobCollectionName),
                target: this.JobCollectionName,
                action: () => 
                {
                    this.SchedulerClient.DisableJobCollection(this.ResourceGroupName, this.JobCollectionName);
