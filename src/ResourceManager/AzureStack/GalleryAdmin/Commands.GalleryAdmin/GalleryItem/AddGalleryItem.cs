...
namespace Microsoft.AzureStack.Commands.GalleryAdmin
{
    ...
    /// <summary>
    /// Gallery Item Cmdlet - Add Operation
    /// </summary>
    [Cmdlet(VerbsCommon.Add, Nouns.GalleryItem)]
    [OutputType(typeof(ResourceDefinition))]
    public class AddGalleryItem : GalleryAdminCmdletBase
    {
        /// <summary>
        ...
        {
            this.WriteVerbose(Resources.AddingGalleryItem);
            var galleryItemUriPayload = new GalleryItemUriPayload()
            {
                GalleryItemUri = this.GalleryItemUri
            };

            this.GalleryAdminClient.AdminGalleryItems.UploadGalleryItem(galleryItemUriPayload);
        }
    }
}
